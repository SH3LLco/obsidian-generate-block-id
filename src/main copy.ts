...
class HumanReadableBlockIDPlugin extends Plugin {
    ...
    generateBlockId(editor, activeLeaf) {
        ...
        // Generate the block ID including the parent headers or file name
